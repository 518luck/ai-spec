...
// # 标签选择器：已选 chips + 添加标签按钮 + Popover（内嵌纯面板 Combobox）
// > 完整的标签选择单元，Filter、editor-toolbar 等场景直接复用
...
// URL 参数名：与 Combobox 内部一致，URL 模式下读写已选 tag id 列表
...
// > 标签选择器：chips + + 按钮 + Popover（内嵌 Combobox 面板）
export function SelectTrigger({
	...
	maskColor,
	className,
}: SelectTriggerProps): JSX.Element | null {
	...
	// 全量标签：URL 模式下用于从 id 反查 name/color 给 chips；SWR key 与 Combobox 一致，共享缓存
