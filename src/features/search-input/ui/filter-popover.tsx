...
import { SEARCH_FIELDS } from "../config/filters";
...
export function FilterPopover({ filters, defaultFilters }: FilterPopoverProps): JSX.Element {
	const { getFilters, setFilters } = useUrl(defaultFilters);
