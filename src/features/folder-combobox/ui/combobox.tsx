...
import { type Icon as IconGlyph, Icons } from "@/shared/ui/icons";
import { Popover, PopoverContent, PopoverTrigger } from "@/shared/ui/popover";
import { Skeleton } from "@/shared/ui/skeleton";
import { Tooltip, TooltipContent, TooltipTrigger } from "@/shared/ui/tooltip";
import { NEUTRAL_COLOR } from "../config/colors";
import { CreateFolderDialog } from "./create-folder-dialog";
import { CreateButton, CreateItemContent } from "./create-items";
...
export type Option = {
	...
	color: string; // 文件夹颜色值（#RRGGBB），驱动 Icon 底色
};
...
export function Combobox({
	...
	const triggerColor = overrideActive
		? (emptyOverride?.color ?? NEUTRAL_COLOR)
		: (selectedOption?.color ?? NEUTRAL_COLOR);
	const triggerIcon: IconGlyph | undefined = overrideActive ? emptyOverride?.icon : undefined;
					...
					<div className="relative">
						...
						>
							...
							<CommandGroup>
								...
								>
									<Icon color={NEUTRAL_COLOR} icon={Icons.folderX} />
