...
import { SIDEBAR_DEFAULT_WIDTH } from "./config";
import { saveSidebarCollapsed, saveSidebarWidth } from "./persistence";
...
// ! 必须在 SidebarProvider 组件内部使用，否则抛错
export const useSidebarContext = (): SidebarContextType => {
	const context = useContext(SidebarContext);

	if (context === null) {
		throw new Error("useSidebarContext 必须在 SidebarProvider 组件内部使用。");
	}
