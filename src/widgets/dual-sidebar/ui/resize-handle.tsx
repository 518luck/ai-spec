...
import { SIDEBAR_COLLAPSE_THRESHOLD, SIDEBAR_MAX_WIDTH, SIDEBAR_MIN_WIDTH } from "../model/config";
...
export function ResizeHandle(): JSX.Element {
	const { width, setWidth, setCollapsed, setIsResizing } = useSidebarContext();
