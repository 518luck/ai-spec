...
export interface PageHandlers {
	...
	fetchVersions: (offset: number) => Promise<ListPage>;
...
export function Page({ handlers }: { handlers: PageHandlers }): JSX.Element {
	...
	const getKey = (_pageIndex: number, previousPageData: ListPage | null) => {
