...
export const morphId = (id: string): string => `record-morph-${id}`;

// # 收录卡片：基于 ContentCard，注入收藏★ + 编辑/版本入口（编辑器由顶层全局管理）
export function Card({ id, name, preview, favorite, onEdit, isEditing }: CardProps): JSX.Element {
