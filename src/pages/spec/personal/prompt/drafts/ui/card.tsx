...
import { PromotePopover } from "./promote-popover";
...
export function Card({ id, name, preview }: CardProps): JSX.Element {
	...
	return (
		...
		>
			{/* 编辑弹窗 */}
			<EditDialog id={id} open={editOpen} onOpenChange={setEditOpen} morphId={morphId} />
		</ContentCard>
	);
}
