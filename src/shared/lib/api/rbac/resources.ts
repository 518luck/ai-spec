...
export const RESOURCES: {
  ...
  // —— 个人内容资源 ——
  {
    key: "promptRecord",
    name: "提示词-收录",
    description: "已收录的提示词，可发布到发现区供他人浏览",
  },
  {
    key: "promptDraft",
    name: "提示词-草稿",
    description: "尚未收录的提示词草稿，仅自己可见",
  },
  {
    key: "rules",
    name: "规约库",
    description: "规约的查看、新建、编辑",
  },
  ...
  // —— 共享资源（个人空间与团队空间共有） ——
  {
    key: "agentMD",
    name: "AGENTS.md",
    description: "AGENTS.md 文档的查看、编辑",
  },
  {
    key: "skills",
    name: "Skills",
  ...
  },
  {
    key: "agents",
    name: "智能体",
    description: "Agents 的查看、新建、编辑",
  },
  {
    key: "plugins",
    name: "Plugins",
    description: "Plugins 的查看、新建、编辑",
  },
