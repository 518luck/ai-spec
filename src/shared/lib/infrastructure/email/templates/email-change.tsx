        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-150 rounded border border-neutral-200 border-solid px-10 py-5">
            ...
            <Section className="my-8 text-center">
              <Link
                href={url}
                className="inline-block rounded-lg bg-black px-6 py-3 text-center font-semibold text-sm text-white no-underline"
              >
                确认更换邮箱
              </Link>
            </Section>
            <Text className="break-all text-neutral-500 text-xs leading-5">
              如果按钮无法点击，请直接访问以下链接：
              <br />
              {url}
            </Text>
            <Text className="text-black text-sm leading-6">此链接 15 分钟后过期。</Text>
